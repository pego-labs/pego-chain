...
func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, overrideBerlin, overrideArrowGlacier, overrideTerminalTotalDifficulty *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	if (stored == common.Hash{}) {
		...
		if genesis.Config.RewardPercent == nil || genesis.Config.RewardPercent.Cmp(big.NewInt(70)) < 0 || genesis.Config.RewardPercent.Cmp(big.NewInt(100)) >= 0 {
			genesis.Config.RewardPercent = big.NewInt(70)
		}
	...
	if genesis == nil && stored != params.MainnetGenesisHash &&
		...
		stored != params.PgGenesisHash && stored != params.PtGenesisHash && stored != params.Pt2GenesisHash {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.PgGenesisHash:
		return params.PGChainConfig
	case ghash == params.PtGenesisHash:
		return params.PTChainConfig
	case ghash == params.Pt2GenesisHash:
		return params.P2ChainConfig
	default:
